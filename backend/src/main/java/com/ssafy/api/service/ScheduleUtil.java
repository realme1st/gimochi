...
public class ScheduleUtil {
    ...
    public void check7Days(List<Gifticon> gifticons, User user) {
        ...
        if (notUsedGifticons.size() == 1) {
            //1장이면 정보 담아서 알림
            notificationService.sendDailyNotification(userId, 7, true, notUsedGifticons);
        } else if (notUsedGifticons.size() > 1) {
            //여러장이면 묶어서 알림
            notificationService.sendDailyNotification(userId, 7, false, notUsedGifticons);
        }
    ...
    public void check3Days(List<Gifticon> gifticons, User user) {
        ...
        if (notUsedGifticons.size() == 1) {
            //1장이면 정보 담아서 알림
            notificationService.sendDailyNotification(userId, 3, true, notUsedGifticons);
        } else if (notUsedGifticons.size() > 1) {
            //여러장이면 묶어서 알림
            notificationService.sendDailyNotification(userId, 3, false, notUsedGifticons);
        }
    }
    ...
    public void check1Day(List<Gifticon> gifticons, User user) {
        ...
        if (notUsedGifticons.size() == 1) {
            //1장이면 정보 담아서 알림
            notificationService.sendDailyNotification(userId, 1, true, notUsedGifticons);
        } else if (notUsedGifticons.size() > 1) {
            //여러장이면 묶어서 알림
            notificationService.sendDailyNotification(userId, 1, false, notUsedGifticons);
        }
    }
}
