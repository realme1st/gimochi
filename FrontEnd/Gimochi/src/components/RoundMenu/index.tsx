...
import { PanGestureHandler, GestureDetector } from 'react-native-gesture-handler';
...
const RoundMenu = ({
  ...
  return (
    <View>
      <PanGestureHandler onHandlerStateChange={onTouchRelease} onGestureEvent={handleGesture}>
        <View style={styles({ size, backgroundColor }).container}>
                ...
                style={[
                  styles({ elContainerSize, elContainerCoOrdinates: { x, y } }).elContainer,
                  {
                    ...
                    borderColor: contentContainerStyle?.borderColor
                      ? contentContainerStyle?.borderColor
                      : undefined,
                    ...
                    borderWidth: contentContainerStyle?.borderWidth
                      ? contentContainerStyle?.borderWidth
                      : undefined,
                  },
                ]}
              >
          ...
          {centerContent ? (
            <View
              style={{
                transform: rotateCenterImage
                  ? [{ rotate: I18nManager.isRTL ? -offsetAngle + 'deg' : offsetAngle + 'deg' }]
                  : null,
