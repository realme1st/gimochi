...
function LoginWebViewScreen({ navigation }) {
      ...
      await axios
        ...
        .then(function (response) {
          ...
          if (!response.data.data.newUser) {
            navigation.navigate('FriendWebViewScreen');
          } else {
            after(
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      <WebView
        ...
        style={{ marginTop: 30 }}
        source={{
          uri: `https://kauth.kakao.com/oauth/authorize?client_id=${Config.KAKAO_REST_API_KEY}&redirect_uri=${Config.API_URL}/kakao/oauth&response_type=code`,
        }}
